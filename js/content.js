/*
 * content.js — every word of the game, in Chinese and English.
 *
 * Each scene is a real decision a foreign founder faces, three plausible ways
 * to answer it, and the rule that actually governs the outcome. `law` cites the
 * instrument the rule comes from so a player can go read the source.
 *
...
(function (root, factory) {
  ...
  var UI = {
    ...
    tagline:      { zh: '外国人来华创业 · 法律闯关小游戏', en: 'A pixel quiz on the law of founding a company in China' },
    ...
    aboutBody: {
      zh: '你扮演一位刚落地中国的外国创业者。八个章节，从签证一路走到数据合规，每一关都是真实的坑。选对了收服法律精灵，选错了……年底见。',
      en: "You play a foreign founder who just landed in China. Eight chapters, from visa to data compliance — every one of them a hole real people have fallen into. Answer well and you befriend the creature. Answer badly and you'll meet it again in December."
    }
  };
